...
// function to query zookeepersArray by name, age, & favorite animal
function filterByQuery(query, zookeepers) {
  // Note that we save the zookeepersArray as filteredResults here:
  let filteredResults = zookeepers;

  if (query.age) {
    filteredResults = filteredResults.filter(
      // Since our form data will be coming in as strings, and out JSON is storing
